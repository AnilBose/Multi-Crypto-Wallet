...
const AccountTransactions: React.FC<AccountTransactionsProps> = ({
  ...
  const getTransactions = useCallback(
    () => {
      ...
      TransactionService.getTransactions(account.address, selectedChain)
        .then((response) => {
        ...
        <tbody>
          {transactions.map((transaction) => (
            <tr key={transaction.hash}>
              ...
              <td>
                <a
                  href={`${selectedChain.blockExplorerUrl}/address/${transaction.from_address}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <td>
                <a
                  href={`${selectedChain.blockExplorerUrl}/address/${transaction.to_address}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <td>
                ...
                {selectedChain.name === "Polygon" ? "MATIC" : "ETH"}
              </td>
